...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            editor.execCommand('insertwordimages', list);
        };
    }
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                pick: {
                    id: '#filePickerReady',
                    label: lang.uploadSelectFile + '(最大'+(fileMaxSize/1024/1000)+'MB)'
                },
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                header['Authorization'] = 'Bearer '+ editor.getOpt('__data__').token;
            ...
            uploader.on('error', function (code, file) {
                if (code == 'Q_EXCEED_NUM_LIMIT') {
                    ...
                    alert('附件最大可上传'+(fileMaxSize/1024/1000)+'MB');
                }
            });
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                pick: {
                    ...
                    label: lang.uploadSelectImage + '(最大'+(imageMaxSize/1024/1000)+'MB)'
                },
                accept: {
                    title: 'Images',
            ...
            uploader.on('error', function (code, file) {
                if (code == 'Q_EXCEED_NUM_LIMIT') {
                    ...
                    alert('图片最大可上传'+(imageMaxSize/1024/1000)+'MB');
                }
            });
            uploader.on('uploadComplete', function (file, ret) {
            });
