...
(function (window, $) {
    ...
    _ve(function (VE, $) {
        ...
        var treeFunction = {
            ...
            addDiyDom: function (treeId, treeNode) {
                ...
                //根据大纲的修改状态显示不同的颜色
                if(treeNode.propertys.changeStatus==2){
                    $('#' + treeNode.tId+ '_span').addClass('outline-bg-modify');
                }else if(treeNode.propertys.changeStatus==1){
    ...
    _ve(function (VE, $) {
        ...
        Tree.fn.updateNodeAndOutline = function (treeNode, outline) {
            ...
            //更新大纲状态显示
            if(treeNode.propertys.changeStatus==2){  //修改
                $('#' + treeNode.tId+ '_span').addClass('outline-bg-modify');
            }else if(treeNode.propertys.changeStatus==1){ //新增
                $('#' + treeNode.tId+ '_span').addClass('outline-bg-add');
    ...
    _ve(function (VE, $) {
        ...
        ToolBar.registerWidgetHandler("InputMenu", function (e, t, n) {
            ...
            function a(n) {
                ("fontfamily" == l || "fontsize" == l) && $.each(e.menu.items, function (e, t) {
                    return t.value.replace(/[', ]/g, "") == n.replace(/['", ]/g, "").toLowerCase() ? (n = t.label.text,
                        !1) : void 0
                }), 
            ...
            return "fontfamily" == l && $(".fui-input", t.getElement()).attr({
                ...
                t.on("itemclick inputcomplete", function (e, t) {
                    var o = t.value;
                    "fontsize" == l && /^[\d]+$/.test(o) && (o += "pt"), n.execCommand(l, o)
                }),

                n.on("selectionchange", function () {
                    var e = n.queryCommandState(l);
                    t[-1 == e ? "disable" : "enable"](),  t[1 == e ? "addClass" : "removeClass"]("fui-button-pressed");
        ...
        VE.fn.renderFUIMenu = function () {
            ...
            var menuConfig = {
                ...
                widgets: [{
                    ...
                    menu: {
                        //一号 二号 三号 小三 四号 小四 五号 小五 10, 11, 12, 14, 16, 18, 20, 24, 36 
                        //单位都是pt
                        items: function () {
                            var items = [];
                            return $.each([
    ...
    _ve(function (VE, $) {
        ...
        WkContent.getTplRelOutline = function () {
            return ' <div class="mousepanel panel panel-default m-t-sm pr wd-wk-container {{outline.wkItem.changeStatus==2? "wd-border-modify":outline.wkItem.changeStatus==1?"wd-border-new":"wd-border-default"}} ">' +
        ...
        WkContent.getTpl = function () {
            return ' <div class="mousepanel panel panel-default m-t-sm pr wd-wk-container {{changeStatus==2? "wd-border-modify":changeStatus==1?"wd-border-new":"wd-border-default"}} ">' +
                '<div class="wk-edit-widget panel-heading text-right panel-default">' +
                '<a><i class="fa fa-edit fa-fw" data-toggle="tooltip" data-placement="top" title="编辑"></i></a>' +
                '</div>' +
                '<div class="wk-exit-widget panel-footer panel-heading text-right wd-hide">' +
    ...
    _ve(function (VE, $) {
        ...
        Outline.update = function (obj) {
            ...
            if ($outline.length > 0) {
                ...
                //更具修改状态显示响应的颜色标记
                if(obj.changeStatus==2){
                    $outline.find(".wd-outline-title").addClass('outline-content-modify');
                }else if(obj.changeStatus == 1){
                    $outline.find(".wd-outline-title").addClass('outline-content-add');
                }else{
                    $outline.find(".wd-outline-title").removeClass('outline-content-modify');
                    $outline.find(".wd-outline-title").removeClass('outline-content-add');
        ...
        Outline.getOutlineRenderTpl = function () {
            return '{{each content as outline i}}' +
                ...
                '              <div class="wd-outline-title vrm-pannel-title {{outline.changeStatus==2? "outline-content-modify":outline.changeStatus==1?"outline-content-add":""}} f16 fl">{{outline.origChapNum}} {{outline.outlineName}}</div>' +
