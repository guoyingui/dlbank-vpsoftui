//init config
(function () {
    var docId = vpUtils.resource.docId; // vp.encrypt.aesDecrypt(vpUtils.resource.docId, "rSzSK900KLMxOgZ/");  // bdyj9GbZmb9P0bLIQ8bqREJkGuSFAdQyzERc8nwEtIg=
    var authcode = vpUtils.resource.authcode;
    /**
     * 配置 基础版本请求地址
     */
    window.config = {
        ...
        websocketUrl: function () {
            return vp.config.URL.odm_websocket;
        },
        /**
         * 转换代理地址
         * @param url 网关假名地址
        ...
        getDocId : function () {
			try
			{
				return vp.encrypt.aesDecrypt(docId, "rSzSK900KLMxOgZ/");
			}
			catch (e)
			{
				console.log(e);
        ...
        deleteOutlineUrl : function () {
            return config.geteway('{vpodm}/odm/wordDocOutline/delete?docId=' + config.getDocId() + "&sparam="+sparam);
        },
        ...
        onlySetControlPoint : function () {
            return config.geteway('{vpodm}/odm/controlPoint/setControlPoint?docId=' + config.getDocId() + "&sparam="+sparam);
        },
        ...
        onlyCancelControlPoint : function () {
            return config.geteway('{vpodm}/odm/controlPoint/cancelControlPoint?docId=' + config.getDocId() + "&sparam="+sparam);
        },

        /**
         * 更新管控点 适用odm
         */
        onlyUpdateControlPoint : function () {
            return config.geteway('{vpodm}/odm/controlPoint/updateControlPoint?docId=' + config.getDocId() + "&sparam="+sparam);
        },
        ...
        outlineRename:function(){
            return config.geteway('{vpodm}/odm/wordDocOutline/rename');
        },
         ...
         */
        getPoint:function(){
            return config.geteway('{vpodm}/odm/controlPoint/getPoint?docId='+config.getDocId());
        },
        ...
        saveUploadDeleteOutline : function () {
            return config.geteway('{vpodm}/odm/doc/saveUploadDeleteOutline?docId=' + config.getDocId());
        },
         ...
         * 获取修订记录
         */
        getReviseUrl:function(){
            return config.geteway('{vpodm}/odm/docRevise/get');
        },
        ...
        senceUrl : function () {
            return config.geteway('{vpodm}/odm/doc/docBusSceneOper/getBusSceneOper?busSceneCode='+config.getAuthCode());
        },
