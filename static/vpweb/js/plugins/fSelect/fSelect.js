        ...
        fSelect.prototype = {
            ...
            buildOptions: function($element) {
                ...
                $element.children().each(function(i, el) {
                    ...
                    if ('optgroup' == $el.prop('nodeName').toLowerCase()) {
                        ...
                        choices += '<div class="fs-option' + selected + '" data-value="' + $el.prop('value') + '"><span class="fs-checkbox"><i></i></span><div class="fs-option-label" hidevalue='+$el.prop('value')+'>' + $el.html() + '</div></div>';
                    }
                });
            ...
            reloadDropdownLabel: function() {
                ...
                this.$wrap.find('.fs-option.selected').each(function(i, el) {
					labelValue.push($(el).find('.fs-option-label').attr("hidevalue"));
                ...
                this.$wrap.find('.fs-label').attr("hidevalue", labelValue);
                this.$select.change();
            }
        }
