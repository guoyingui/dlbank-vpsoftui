...
Ext.define("Gnt.template.Milestone1", {
	extend: "Gnt.template.Template",
	innerTpl: (Ext.isIE8m || Ext.isIEQuirks ? '<img style="position:relative;top:2px;left:-3px;" src="../../vpm/images/wbstask/icon_task_milestone1.gif"/>' : '<img style="position:relative;top:-2px;left:-1px;" src="../../vpm/images/wbstask/icon_task_milestone1.gif"/>'),
	getInnerTpl: function(a) {
...
Ext.define("Gnt.template.Milestone2", {
	extend: "Gnt.template.Template",
	innerTpl: (Ext.isIE8m || Ext.isIEQuirks ? '<img style="position:relative;top:2px;left:-3px;" src="../../vpm/images/wbstask/icon_task_milestone2.gif"/>' : '<img style="position:relative;top:-2px;left:-1px;" src="../../vpm/images/wbstask/icon_task_milestone2.gif"/>'),
	getInnerTpl: function(a) {
		return "<div " + (this.isLegacyIE ? 'style="width:{[Math.floor(values.side*0.7)]}px"': "") + ' id="' + a.prefix + '{id}" class="sch-gantt-item sch-gantt-milestone-diamond-ctd">'+this.innerTpl+'</div>'
	}
});
Ext.define("Gnt.template.Milestone3", {
	extend: "Gnt.template.Template",
	innerTpl: (Ext.isIE8m || Ext.isIEQuirks ? '<img style="position:relative;top:2px;left:-3px;" src="../../vpm/images/wbstask/icon_task_milestone3.gif"/>' : '<img style="position:relative;top:-2px;left:-1px;" src="../../vpm/images/wbstask/icon_task_milestone3.gif"/>'),
	getInnerTpl: function(a) {
		return "<div " + (this.isLegacyIE ? 'style="width:{[Math.floor(values.side*0.7)]}px"': "") + ' id="' + a.prefix + '{id}" class="sch-gantt-item sch-gantt-milestone-diamond-ctd">'+this.innerTpl+'</div>'
	}
});
Ext.define("Gnt.template.Milestone4", {
	extend: "Gnt.template.Template",
	innerTpl: (Ext.isIE8m || Ext.isIEQuirks ? '<img style="position:relative;top:2px;left:-3px;" src="../../vpm/images/wbstask/icon_task_milestone4.gif"/>' : '<img style="position:relative;top:-2px;left:-1px;" src="../../vpm/images/wbstask/icon_task_milestone4.gif"/>'),
	getInnerTpl: function(a) {
		return "<div " + (this.isLegacyIE ? 'style="width:{[Math.floor(values.side*0.7)]}px"': "") + ' id="' + a.prefix + '{id}" class="sch-gantt-item sch-gantt-milestone-diamond-ctd">'+this.innerTpl+'</div>'
	}
});
Ext.define("Gnt.template.Milestone5", {
	extend: "Gnt.template.Template",
	innerTpl: (Ext.isIE8m || Ext.isIEQuirks ? '<img style="position:relative;top:2px;left:-3px;" src="../../vpm/images/wbstask/icon_task_milestone5.gif"/>' : '<img style="position:relative;top:-2px;left:-1px;" src="../../vpm/images/wbstask/icon_task_milestone5.gif"/>'),
	getInnerTpl: function(a) {
		return "<div " + (this.isLegacyIE ? 'style="width:{[Math.floor(values.side*0.7)]}px"': "") + ' id="' + a.prefix + '{id}" class="sch-gantt-item sch-gantt-milestone-diamond-ctd">'+this.innerTpl+'</div>'
	}
});
...
Ext.define("Gnt.panel.Gantt", {
	...
	requires: ["Ext.layout.container.Border", "Gnt.view.Gantt", "Gnt.model.Dependency", "Gnt.data.ResourceStore", "Gnt.data.AssignmentStore", "Gnt.feature.WorkingTime", "Gnt.data.Calendar", "Gnt.data.TaskStore", "Gnt.data.DependencyStore"],
...
Ext.define("Gnt.field.Dependency", {
	...
	applyChanges: function(d) {
		...
		if (d.data.Id == this.getRawValue()) {
			alert("输入错误，不能前置节点也是自己。");
			return;
		}
...
Ext.define("Gnt.column.ResourceName", {
	...
	renderer:function(v,m,r){
		...
		//m.tdCls=vpGantt.getResIcon(r.get("IconType"))||'../../vpm/ext4/s.gif';
...
*/				
			...
			// 问题: WBS甘特图，在预测完成日期处点击一下然后点击保存，工期就减少一天
			/*if (a.column == this) {
			...
			// 上述代码逻辑会导致, 目前先注释整段逻辑(老系统也有此逻辑, 但没有此问题, 尚未排查出根本原因)
