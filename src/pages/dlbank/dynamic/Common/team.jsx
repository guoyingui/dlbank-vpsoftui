...
import Choosen from './ChooseEntity'
                                            ...
                                            onClick={(e) => this.groupClick(e, '-1', '', '0')}><a id="role-1" className="active">全部（{this.state.allcount}）</a></li>
                                        {
                                            this.state.roleGroup ?
                                                this.state.roleGroup.map((item, index) => {
                                                    return (
                                                        <li className="li-layout" key={index} onClick={(e) => this.groupClick(e, item.iid, item.iprincipal, item.iroletype)}>
                                                            <div className="left">
                                                                <a id={"role" + item.iid}>{item.sname}（{item.count}）</a>
                                                            </div>
                                                            <div className="right">
                                                                {
                                                                    item.iroletype != 4 && item.iroletype != 0 && (
                                                                        <VpTooltip placement="top" title="关联成员">
                                                                            <VpButton
                                                                                // type="primary" 
                                                                                shape="circle"
                                                                                icon="plus"
                                                                                onClick={(e) => _this.addRel(e)}
                                                                            />
                                                                        </VpTooltip>
                                                                    )
                                                                }
                    ...
                    >
                        {
                            this.state.visible ?
                                <Choosen
                                    ...
                                    propsentityid={_this.props.entityid}//父实体id
                                    propsiid = {_this.props.iid }  //父实体对象id
                                />
                                :
                                null
                        }
