...
exports["default"] = {
  ...
  setValue: function setValue(v) {
    ...
    if (newValue !== this.state.value) {
      ...
      // revert input value
      var value = this.setFormatter(this.state.value);
      this.setState({
        inputValue: value
      });
    }
  ...
  setFormatter: function setFormatter(value) {
    try {
  ...
  setParser: function setParser(value) {
    try {
